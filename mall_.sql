...
-- mall_ のデータベース構造をダンプしています
CREATE DATABASE IF NOT EXISTS `mall_` /*!40100 DEFAULT CHARACTER SET utf8mb3 */;
USE `mall_`;

--  テーブル mall_.cms_help の構造をダンプしています
...
-- テーブル mall_.cms_help: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `cms_help` DISABLE KEYS */;
/*!40000 ALTER TABLE `cms_help` ENABLE KEYS */;

--  テーブル mall_.cms_help_category の構造をダンプしています
...
-- テーブル mall_.cms_prefrence_area: ~4 rows (約) のデータをダンプしています
...
--  テーブル mall_.cms_prefrence_area_product_relation の構造をダンプしています
...
-- テーブル mall_.cms_prefrence_area_product_relation: ~8 rows (約) のデータをダンプしています
...
--  テーブル mall_.cms_subject の構造をダンプしています
...
-- テーブル mall_.cms_subject: ~6 rows (約) のデータをダンプしています
...
--  テーブル mall_.cms_subject_category の構造をダンプしています
...
-- テーブル mall_.cms_subject_category: ~2 rows (約) のデータをダンプしています
...
--  テーブル mall_.cms_subject_comment の構造をダンプしています
...
-- テーブル mall_.cms_subject_comment: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `cms_subject_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `cms_subject_comment` ENABLE KEYS */;

--  テーブル mall_.cms_subject_product_relation の構造をダンプしています
...
-- テーブル mall_.cms_subject_product_relation: ~13 rows (約) のデータをダンプしています
...
--  テーブル mall_.cms_topic の構造をダンプしています
...
-- テーブル mall_.cms_topic: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `cms_topic` DISABLE KEYS */;
/*!40000 ALTER TABLE `cms_topic` ENABLE KEYS */;

--  テーブル mall_.cms_topic_category の構造をダンプしています
...
-- テーブル mall_.oms_cart_item: ~88 rows (約) のデータをダンプしています
...
--  テーブル mall_.oms_company_address の構造をダンプしています
...
-- テーブル mall_.oms_company_address: ~3 rows (約) のデータをダンプしています
...
--  テーブル mall_.oms_order の構造をダンプしています
...
-- テーブル mall_.oms_order: ~57 rows (約) のデータをダンプしています
...
--  テーブル mall_.oms_order_item の構造をダンプしています
...
-- テーブル mall_.oms_order_item: ~83 rows (約) のデータをダンプしています
...
--  テーブル mall_.oms_order_operate_history の構造をダンプしています
...
-- テーブル mall_.oms_order_operate_history: ~33 rows (約) のデータをダンプしています
...
--  テーブル mall_.oms_order_return_apply の構造をダンプしています
...
-- テーブル mall_.oms_order_return_apply: ~21 rows (約) のデータをダンプしています
...
--  テーブル mall_.oms_order_return_reason の構造をダンプしています
...
-- テーブル mall_.oms_order_return_reason: ~9 rows (約) のデータをダンプしています
...
--  テーブル mall_.oms_order_setting の構造をダンプしています
...
-- テーブル mall_.oms_order_setting: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_album の構造をダンプしています
...
-- テーブル mall_.pms_album: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `pms_album` DISABLE KEYS */;
/*!40000 ALTER TABLE `pms_album` ENABLE KEYS */;

--  テーブル mall_.pms_album_pic の構造をダンプしています
...
-- テーブル mall_.pms_brand: ~12 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_comment の構造をダンプしています
...
-- テーブル mall_.pms_comment: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `pms_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `pms_comment` ENABLE KEYS */;

--  テーブル mall_.pms_comment_replay の構造をダンプしています
...
-- テーブル mall_.pms_member_price: ~80 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product の構造をダンプしています
...
-- テーブル mall_.pms_product: ~38 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_attribute の構造をダンプしています
...
-- テーブル mall_.pms_product_attribute: ~53 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_attribute_category の構造をダンプしています
...
-- テーブル mall_.pms_product_attribute_category: ~12 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_attribute_value の構造をダンプしています
...
-- テーブル mall_.pms_product_attribute_value: ~130 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_category の構造をダンプしています
...
-- テーブル mall_.pms_product_category: ~40 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_category_attribute_relation の構造をダンプしています
...
-- テーブル mall_.pms_product_category_attribute_relation: ~5 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_full_reduction の構造をダンプしています
...
-- テーブル mall_.pms_product_full_reduction: ~36 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_ladder の構造をダンプしています
...
-- テーブル mall_.pms_product_ladder: ~35 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_product_operate_log の構造をダンプしています
...
-- テーブル mall_.pms_product_operate_log: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `pms_product_operate_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `pms_product_operate_log` ENABLE KEYS */;

--  テーブル mall_.pms_product_vertify_record の構造をダンプしています
...
-- テーブル mall_.pms_product_vertify_record: ~2 rows (約) のデータをダンプしています
...
--  テーブル mall_.pms_sku_stock の構造をダンプしています
...
-- テーブル mall_.pms_sku_stock: ~96 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_coupon の構造をダンプしています
...
-- テーブル mall_.sms_coupon: ~5 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_coupon_history の構造をダンプしています
...
-- テーブル mall_.sms_coupon_history: ~9 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_coupon_product_category_relation の構造をダンプしています
...
-- テーブル mall_.sms_coupon_product_category_relation: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_coupon_product_relation の構造をダンプしています
...
-- テーブル mall_.sms_coupon_product_relation: ~4 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_flash_promotion の構造をダンプしています
...
-- テーブル mall_.sms_flash_promotion: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_flash_promotion_log の構造をダンプしています
...
-- テーブル mall_.sms_flash_promotion_log: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `sms_flash_promotion_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `sms_flash_promotion_log` ENABLE KEYS */;

--  テーブル mall_.sms_flash_promotion_product_relation の構造をダンプしています
...
-- テーブル mall_.sms_flash_promotion_product_relation: ~47 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_flash_promotion_session の構造をダンプしています
...
-- テーブル mall_.sms_flash_promotion_session: ~7 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_home_advertise の構造をダンプしています
...
-- テーブル mall_.sms_home_advertise: ~11 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_home_brand の構造をダンプしています
...
-- テーブル mall_.sms_home_brand: ~9 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_home_new_product の構造をダンプしています
...
-- テーブル mall_.sms_home_new_product: ~9 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_home_recommend_product の構造をダンプしています
...
-- テーブル mall_.sms_home_recommend_product: ~5 rows (約) のデータをダンプしています
...
--  テーブル mall_.sms_home_recommend_subject の構造をダンプしています
...
-- テーブル mall_.sms_home_recommend_subject: ~6 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_admin の構造をダンプしています
...
-- テーブル mall_.ums_admin: ~8 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_admin_login_log の構造をダンプしています
...
-- テーブル mall_.ums_admin_login_log: ~411 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_admin_permission_relation の構造をダンプしています
...
-- テーブル mall_.ums_admin_role_relation: ~6 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_growth_change_history の構造をダンプしています
...
-- テーブル mall_.ums_growth_change_history: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_integration_change_history の構造をダンプしています
...
-- テーブル mall_.ums_integration_change_history: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_integration_consume_setting の構造をダンプしています
...
-- テーブル mall_.ums_integration_consume_setting: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_member の構造をダンプしています
...
-- テーブル mall_.ums_member: ~9 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_member_level の構造をダンプしています
...
-- テーブル mall_.ums_member_level: ~4 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_member_login_log の構造をダンプしています
...
-- テーブル mall_.ums_member_login_log: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `ums_member_login_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `ums_member_login_log` ENABLE KEYS */;

--  テーブル mall_.ums_member_member_tag_relation の構造をダンプしています
...
-- テーブル mall_.ums_member_member_tag_relation: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_member_product_category_relation の構造をダンプしています
...
-- テーブル mall_.ums_member_product_category_relation: ~0 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_member_receive_address の構造をダンプしています
...
-- テーブル mall_.ums_member_receive_address: ~3 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_member_rule_setting の構造をダンプしています
...
-- テーブル mall_.ums_member_rule_setting: ~0 rows (約) のデータをダンプしています
/*!40000 ALTER TABLE `ums_member_rule_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `ums_member_rule_setting` ENABLE KEYS */;

--  テーブル mall_.ums_member_statistics_info の構造をダンプしています
...
-- テーブル mall_.ums_menu: ~24 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_permission の構造をダンプしています
...
-- テーブル mall_.ums_permission: ~18 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_resource の構造をダンプしています
...
-- テーブル mall_.ums_resource: ~31 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_resource_category の構造をダンプしています
...
-- テーブル mall_.ums_resource_category: ~6 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_role の構造をダンプしています
...
-- テーブル mall_.ums_role: ~3 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_role_menu_relation の構造をダンプしています
...
-- テーブル mall_.ums_role_menu_relation: ~35 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_role_permission_relation の構造をダンプしています
...
-- テーブル mall_.ums_role_permission_relation: ~17 rows (約) のデータをダンプしています
...
--  テーブル mall_.ums_role_resource_relation の構造をダンプしています
...
-- テーブル mall_.ums_role_resource_relation: ~46 rows (約) のデータをダンプしています
